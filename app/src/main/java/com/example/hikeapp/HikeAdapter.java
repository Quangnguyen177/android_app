...
public class HikeAdapter extends RecyclerView.Adapter<HikeAdapter.ViewHolder> {
    ...
    public HikeAdapter(ArrayList<Hike> mylist, AllHikeAcivity context) {
        this.mylist = mylist;
    ...
    public void onBindViewHolder(@NonNull HikeAdapter.ViewHolder holder, int position) {
        ...
        holder.btn_deleteHike.setOnClickListener(new View.OnClickListener() {
            DBHelper dbHelper = new DBHelper(context);
            @Override
            public void onClick(View view) {
                dbHelper.deleteHike(mylist.get(position).getIdHike());
                Intent intent = new Intent(context, AllHikeAcivity.class);
                context.startActivity(intent);
            }
        });
    }
